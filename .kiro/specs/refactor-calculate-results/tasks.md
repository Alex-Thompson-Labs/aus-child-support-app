...
- [x] 3. Extract Income Calculator module
  - [x] 3.1 Create `src/utils/income-calculator.ts`
  ...
  - [x] 3.2 Update calculateResults.ts to use income-calculator
    - Replace inline income calculations with module call
    - Re-export for backward compatibility
    - _Requirements: 8.3, 8.4_
  - [x] 3.3 Write property test for CSI formula correctness
    - **Property 3: CSI Formula Correctness**
    - **Validates: Requirements 2.2**
  - [x] 3.4 Write property test for income percentages sum to 100%
    - **Property 4: Income Percentages Sum to 100%**
    - **Validates: Requirements 2.5**

- [x] 4. Extract Liability Calculator module
  - [x] 4.1 Create `src/utils/liability-calculator.ts`
  ...
  - [x] 4.2 Update calculateResults.ts to use liability-calculator
    - Replace inline liability calculations with module call
    - Re-export for backward compatibility
    - _Requirements: 8.3, 8.4_
  - [x] 4.3 Write property test for liability formula correctness
    - **Property 5: Liability Formula Correctness**
    - **Validates: Requirements 3.2, 3.5**
  - [x] 4.4 Write property test for zero liability for low care
    - **Property 6: Zero Liability for Low Care**
    - **Validates: Requirements 3.3**
  - [x] 4.5 Write property test for zero liability for adult children
...
- [x] 6. Extract Rates Engine module
  - [x] 6.1 Create `src/utils/engine/rates-engine.ts`
  ...
  - [x] 6.2 Update engine/index.ts to export rates-engine
    - Re-export all public APIs
    - _Requirements: 9.2, 9.4_
  - [x] 6.3 Update calculateResults.ts to use rates-engine
    - Replace inline FAR/MAR logic with module call
    - Re-export for backward compatibility
    - _Requirements: 8.3, 8.4_
  - [x] 6.4 Write property test for MAR eligibility conditions
    - **Property 8: MAR Eligibility Conditions**
    - **Validates: Requirements 4.3**
  - [x] 6.5 Write property test for FAR eligibility conditions
    - **Property 9: FAR Eligibility Conditions**
    - **Validates: Requirements 4.5**
  - [x] 6.6 Write property test for FAR 3-child cap
    - **Property 10: FAR 3-Child Cap**
    - **Validates: Requirements 4.7, 5.7**

- [x] 7. Extract Multi-Case Engine module
  - [x] 7.1 Create `src/utils/engine/multi-case-engine.ts`
  ...
  - [x] 7.2 Update engine/index.ts to export multi-case-engine
    - Re-export all public APIs
    - _Requirements: 9.3, 9.4_
  - [x] 7.3 Update calculateResults.ts to use multi-case-engine
    - Replace inline multi-case cap logic with module call
    - Re-export for backward compatibility
    - _Requirements: 8.3, 8.4_
  - [x] 7.4 Write property test for multi-case cap uses solo CSI
    - **Property 11: Multi-Case Cap Uses Solo CSI**
    - **Validates: Requirements 5.3**

- [-] 8.l Extract Payment Resolver module
  - [x] 8.1 Create `src/utils/payment-resolver.ts`
  ...
  - [x] 8.2 Update calculateResults.ts to use payment-resolver
    - Replace inline payment resolution with module call
    - Re-export for backward compatibility
    - _Requirements: 8.3, 8.4_
  - [x] 8.3 Write property test for net payment formula
    - **Property 12: Net Payment Formula**
    - **Validates: Requirements 6.2**
  - [x] 8.4 Write property test for payer/receiver determination
    - **Property 13: Payer/Receiver Determination**
    - **Validates: Requirements 6.3, 6.4**
  - [x] 8.5 Write property test for zero payment yields neither
...
- [x] 10. Finalize orchestration and backward compatibility
  - [x] 10.1 Refactor calculateResults.ts as thin orchestration layer
  ...
  - [x] 10.2 Write property test for null on validation failure
    - **Property 15: Null on Validation Failure**
    - **Validates: Requirements 7.3**
  - [x] 10.3 Write property test for override values take precedence
    - **Property 16: Override Values Take Precedence**
    - **Validates: Requirements 7.5**
  - [x] 10.4 Write property test for backward compatibility - identical results

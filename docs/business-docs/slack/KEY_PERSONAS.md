...
## 🎯 Primary Persona 1: Sarah - The Concerned Parent
...
- ✅ Free, instant, accurate calculations (no registration required)
- ✅ Clear, step-by-step breakdown (simple explanation + technical details toggle)
- ✅ Mobile-responsive (works perfectly on phone)
- ✅ Privacy-first (encrypted storage, no data sold)

**Complexity Detection:**

- ✅ Automatic alerts when case might need legal help
- ✅ Educational content (explains why, not just "buy lawyer")
- ✅ Change of Assessment education (10 official grounds explained)
- ✅ Alerts at optimal moments (after calculation, not intrusive)

**Lead Capture (If Needed):**

- ✅ Optional "Get Legal Help" button (not forced)
- ✅ Clear consent mechanism (privacy policy, checkboxes)
- ✅ Simple form (pre-populated with calculation data)
- ✅ Transparency (knows this connects them with lawyers)
...
## 💼 Primary Persona 2: Michael - The Small Law Firm Partner
...
- ✅ Case context included (full calculation history, CoA reasons)
...
- ✅ Simple onboarding (email signup, payment setup)
- ✅ Automated billing (monthly Stripe invoices)
- ✅ Mobile-friendly admin dashboard (manage on phone)
- ✅ Fast lead delivery (24-48 hour turnaround)
...
## 👥 Secondary Persona: David - The High-Value Case Parent
...
- ✅ Complexity detection identifies high-value cases automatically
- ✅ Change of Assessment education (10 official grounds explained)
- ✅ Court date urgency alerts (prompts for immediate legal help)
- ✅ Quality lawyer matching (pre-qualified family law specialists)
...
## 👥 Secondary Persona: Lisa - The Validation Lawyer
...
- ✅ Free leads during Phase 3A validation (no cost, no risk)
- ✅ Exclusive access to leads in their city (if validation partner)
- ✅ Direct feedback loop (improve lead quality based on input)
- ✅ Potential for early adopter benefits (preferred pricing, volume guarantees)
...
## 🎯 Persona-Based Product Decisions

### For Parents (Sarah)

**Design Decisions:**

- ✅ Mobile-first design (60% use phone)
- ✅ No registration required (reduce friction)
- ✅ Simple explanation by default (technical toggle for power users)
- ✅ Clear privacy messaging (reassure concerns)

**Feature Priorities:**

- ✅ Instant calculations (no waiting)
- ✅ Complexity education (explain why case is complex)
- ✅ Optional lawyer connection (not forced)
- ✅ Transparent consent (clear what data is shared)
...
- If yes → Build it
- If no → Reconsider priority

**Example:** PDF export for parents

- ✅ Serves Sarah (share with ex-partner, save for records)
- ❌ Doesn't serve Michael directly (but increases parent value)
...
- Parent messaging → Privacy, free, instant results
- Lawyer messaging → ROI, quality, risk mitigation

### When Prioritizing Work

**Priority Order:**

1. **Revenue-Enabling** → Features that let Michael pay (Stripe, lawyer onboarding)
2. **Revenue-Increasing** → Features that increase parent conversion (better complexity detection)
3. **Efficiency** → Features that save time (automation, analytics)
4. **Nice-to-Have** → Features that enhance experience (PDF export, mobile apps)

...
**Free child support calculator → Pre-qualified leads for family lawyers**
...
1. **Parent uses calculator** → Free, instant calculation (auschildsupport.com)
2. **Complex case detected** → Alert shown ("High Value", "Court Date Urgent", "Change of Assessment")
3. **Parent clicks "Get Legal Help"** → Fills inquiry form (consent checkbox, case details)
4. **Lead saved to database** → Supabase (encrypted, Privacy Act compliant)
...
**Success Metrics (Phase 3A):** 15%+ consultation rate OR 1 exclusive partner signed → Proceed to Phase 3B
...
✅ Lead capture system (inquiry form, Supabase database)  
...
⏳ **Week 3-8: Execute & Document**

- Setup partner program OR place free leads with validation lawyers
- Track metrics: Lead→Consultation rate (target: 15%+)
...
- ✅ **If 15%+ consultation rate OR Exclusive Partner signed** → Proceed to Phase 3B (February 2026)
...
| Risk                                      | Mitigation                                                                                                      |
| ----------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| Validation fails (<10% consultation rate) | ✅ Validation-first approach - test with free leads before asking lawyers to pay                                |
...
| Privacy Act compliance                    | ✅ RESOLVED - Database with proper consent, privacy policy, audit trails, deletion capability                   |

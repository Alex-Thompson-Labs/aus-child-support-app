 ...
 *
 * Moved here from src/utils/coa-reasons.ts to reduce bundle size impact
 * on components that only need types or helpers.
 */

import { CoAReasonPage } from '../utils/coa-reasons';
...
export const COA_REASON_PAGES: readonly CoAReasonPage[] = [
    {
        ...
        plainEnglishExplanation: `If you spend a lot of money travelling to see your children, you may be able to have your child support assessment changed. This is "Reason 1" under the Child Support (Assessment) Act.

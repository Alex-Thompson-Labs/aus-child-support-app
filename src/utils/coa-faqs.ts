 ...
 *
 * @param slug - The URL slug of the CoA reason
 * @returns Array of FAQs for that reason, or empty array if not found
 */
 ...
 *
 * @param slug - The URL slug of the CoA reason
 * @returns FAQPage schema object for structured data
 */

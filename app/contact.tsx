...
const contactSchema = {
    ...
    description: 'Contact us for questions about the Australian Child Support Calculator.',
    mainEntity: {
        '@type': 'Organization',
            ...
            <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
                ...
                >
                    ...
                    <Text style={styles.introText}>
                        Have questions about child support calculations or need professional advice?
                    ...
                    <View style={styles.contactCard}>
                        ...
                        <Text style={styles.cardDescription}>
                            Connect with independent family law professionals who can review your
                            child support situation and provide tailored advice.
                        </Text>
                        <Pressable
                    ...
                    <View style={styles.contactCard}>
                        ...
                        <Text style={styles.cardDescription}>
                            Read articles about child support, family law, and financial planning
                            for separated parents in Australia.
                        </Text>
                        <Pressable
                    ...
                    <View style={styles.disclaimer}>
                        <Text style={styles.disclaimerText}>
                            AusChildSupport provides estimation tools only. For official child support
                            assessments, contact Services Australia directly.
                        </Text>
                    </View>
                </ScrollView>
            </SafeAreaView>

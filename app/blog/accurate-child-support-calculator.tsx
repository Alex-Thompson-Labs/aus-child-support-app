                ...
                <ScrollView style={styles.scrollView} contentContainerStyle={[styles.scrollContent, webContainerStyle]}>
                    ...
                    >
                        <Text style={styles.ctaButtonText}>
                            Read: 8 Situations That Need Legal Advice →
                        </Text>
                    </Pressable>
                    ...
                    <View style={styles.finalCtaSection}>
                        ...
                        <Text style={styles.finalCtaText}>
                            ...
                            or disputes, connect with experienced family lawyers who can provide accurate assessments 
                            and legal advice.
                        </Text>
                        <Pressable
...
const styles = StyleSheet.create({
    ...
    dangerBox: { backgroundColor: '#fef2f2', borderRadius: 12, borderWidth: 2, borderColor: '#dc2626', padding: 20, marginBottom: 16, ...createShadow({ shadowColor: '#dc2626', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 3 }) },

                ...
                <ScrollView style={styles.scrollView} contentContainerStyle={[styles.scrollContent, webContainerStyle]}>
                    ...
                    <View style={styles.finalCtaSection}>
                        ...
                        <Text style={styles.finalCtaText}>
                            Connect with experienced family lawyers who can draft, review, or challenge Binding Child 
                            Support Agreements.
                        </Text>
                        <Pressable
...
const styles = StyleSheet.create({
    ...
    definitionCard: { backgroundColor: '#f0f9ff', borderRadius: 12, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#bae6fd' },
    definitionTitle: { fontSize: 16, fontWeight: '700', color: '#0c4a6e', marginBottom: 12 },
    ...
    costCard: { backgroundColor: '#fefce8', borderRadius: 12, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#fde047' },
    costTitle: { fontSize: 16, fontWeight: '700', color: '#713f12', marginBottom: 12 },
    costTotal: { fontSize: 16, fontWeight: '700', color: '#713f12', marginTop: 8, paddingTop: 8, borderTopWidth: 1, borderTopColor: '#fde047' },
    ...
    optionCard: { backgroundColor: '#f5f3ff', borderRadius: 12, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#c4b5fd' },
    optionTitle: { fontSize: 16, fontWeight: '700', color: '#5b21b6', marginBottom: 8 },
    optionText: { fontSize: 15, lineHeight: 24, color: '#6b21a8', marginBottom: 8 },
    optionPros: { fontSize: 14, lineHeight: 22, color: '#059669', marginBottom: 4 },
    optionCons: { fontSize: 14, lineHeight: 22, color: '#dc2626', marginBottom: 4 },
